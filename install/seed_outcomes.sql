...
FROM (
  ...
  UNION ALL SELECT 'INTERESTED','Interesado',30,'PENDING',0,0,0,1
  UNION ALL SELECT 'NOT_INTERESTED','No interesado',40,'PENDING',0,0,0,1
  UNION ALL SELECT 'SALE','Venta',50,'PENDING',0,0,0,1
  UNION ALL SELECT 'INVALID_NUMBER','Número inválido',60,'PENDING',0,0,0,1
  UNION ALL SELECT 'NO_CONTACT','Sin contacto',70,'PENDING',0,0,0,1
  UNION ALL SELECT 'CLOSED_OTHER','Cerrado - otro',80,'PENDING',0,0,0,1
) s
